...
def proc_video(
    ...
    if filtered:
        vname = vname.replace("_filtered", "")
        videooutname1 = os.path.join(vname + "_filtered_labeled.mp4")
        videooutname2 = os.path.join(vname + "_filtered_labeled.mp4")
    else:
        videooutname1 = os.path.join(vname + "_labeled.mp4")
        videooutname2 = os.path.join(vname + "_labeled.mp4")
